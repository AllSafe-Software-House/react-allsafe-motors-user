                ...
                <div className='flex'>
                    <div className='px-2 my-3'>
                        <label className='flex items-center'>
                            ...
                            />
                            <span className='ml-2'>{t('payment.arkan')}</span>
                        </label>
                    </div>
                    <div className='px-2 my-3'>
                        <label className='flex items-center'>
                            <input
                                ...
                                className="text-red-600"
                            />
                            <span className='ml-2'>{t('payment.natural')}</span>
                        </label>
                    </div>
                    <div className='px-2 my-3'>
                        <label className='flex items-center'>
